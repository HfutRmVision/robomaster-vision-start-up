...
* 探索智能决策方向时 → [强化学习](reinforcement-learning.md)
* 做深度学习、需要 Python 训练模型时 → [Python 入门（选学）](python.md)
...
| [强化学习](reinforcement-learning.md) | 智能体通过试错学习决策 | 探索方向，有余力再看 |
| [Python 入门（选学）](python.md) | Python 语法与科学计算生态 | 进入深度学习阶段前 |
