...
* 绝大多数电脑选 **x86_64** 版本（文件名类似 `msys2-x86_64-latest.exe`）
...
> 📷 **截图占位**：UCRT64 终端首次运行 `pacman -Suy` 的输出（待补充）
...
下一步 → [安装工具链](install-toolchain.md)
